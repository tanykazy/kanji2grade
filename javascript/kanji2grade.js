 ...
 * @param {string} kanji One kanji to look up
 * @return {number} Kanji dividend grade
 */
function kanji2grade(kanji) {
    ...
    if (kanji.length !== 1) {
        throw new TypeError("length of string object is not 1");
    }

    for (let grade in KanjiTableByGrade) {
        if (KanjiTableByGrade[grade].indexOf(kanji) !== -1) {
...
/**
 * @type {object} key and value is the pair of grade and Kanjis.
 * See {@link https://www.mext.go.jp/}.
 */
const KanjiTableByGrade = {
